...
<div class="container mt-5">
    ...
    if (isset($_POST['aggiungi'])) {
        ...
        $sql = "INSERT INTO tasks (titoloTask, descrizione, stato, user_id)
        VALUES ('$titoloTask', '$descrizione', '$stato', '$user_id')";
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <?php
            $result = $conn->query("
    SELECT tasks.id, tasks.titoloTask, tasks.descrizione, tasks.stato
    FROM tasks
